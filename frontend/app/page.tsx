      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-120px)] px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Link
              href="/upload"
              className="group relative px-8 py-4 bg-gradient-to-r from-green-600 to-green-700 text-white font-mono font-bold text-lg rounded-lg shadow-xl shadow-green-900/50 hover:shadow-2xl hover:shadow-green-900/70 transition-all duration-200 hover:scale-105"
            >
              <div className="flex items-center gap-3">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
