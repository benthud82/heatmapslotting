...
interface SidebarProps {
    activeTool: 'select' | 'pan' | ElementType;
    onSelectTool: (tool: 'select' | 'pan' | ElementType) => void;
}
...
export default function Sidebar({ activeTool, onSelectTool }: SidebarProps) {
    const tools = [
        ...
        { id: 'pan', icon: 'M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z', label: 'Pan (Space)', type: 'pan' },
            ...
            {tools.map((tool) => (
                ...
                >
                    ...
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        {tool.id === 'pan' && <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z" />}
